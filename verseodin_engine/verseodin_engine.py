  ...
  worker:
    ...
    strategy:
      matrix:
        worker:
          ...
          - name: worker2
            delay: 1200    # starts 20 minutes after worker1
          - name: worker3
            delay: 2400    # starts 40 minutes after worker1
    ...
    steps:
      ...
      - name: Run verseodin engine
        ...
        run: |
          cd verseodin_engine
          python verseodin_engine.py --work-seconds 3600 --total-seconds 3600 --poll-seconds 3 --task-timeout 600
